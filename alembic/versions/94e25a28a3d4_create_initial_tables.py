...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_blog_category_id'), 'blog_category', ['id'], unique=False
    )
    op.create_table(
        'blog_location',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f('ix_blog_location_id'), 'blog_location', ['id'], unique=False
    )
    op.create_table(
        'blog_post',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f('ix_blog_comment_id'), 'blog_comment', ['id'], unique=False
    )
